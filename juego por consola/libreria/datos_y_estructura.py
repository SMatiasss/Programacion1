#Listas a operar
tablero = [False, 1, None, None, None, 3, None, None, None, None, None, 1, None, None, 2, 1, 1, 
                   None, None, None, 1, None, None, 2, None, None, None, 1, None, None, True]

posicion = [15]

#Estructura

pregunta_desea_jugar = """
¿Desea jugar?
(s/n): """
pregunta_desea_continuar = """
¿Desea continuar?
(s/n): """
