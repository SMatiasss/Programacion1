def revertir_flags(flags: dict, nombres: tuple):
    for nombre in nombres:
        flags[nombre] = not flags[nombre]
...
def devolver_colision(rectangulos:list, posicion_mouse: tuple, opciones: tuple, funcion)-> bool:
    colision = None
