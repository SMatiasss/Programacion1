...
from funciones_compras_online import listar_datos_de_brasil,listar_datos_de_mexico,listar_datos_italianos40,determinar_premedio_de_edad,listar_datos_joven,listar_mayor_de_brasil,listar_mexico_brasil_zip8000,cerrar_menu
